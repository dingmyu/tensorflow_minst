...
classifier.fit(mnist.train.images, labels, batch_size=100, steps=1000)
score = metrics.accuracy_score(
    test_labels, classifier.predict(mnist.test.images))
...
classifier = learn.TensorFlowEstimator(
    ...
    learning_rate=0.001)
classifier.fit(mnist.train.images, labels)
score = metrics.accuracy_score(
    test_labels, classifier.predict(mnist.test.images))
print('Accuracy: {0:f}'.format(score))
'''
